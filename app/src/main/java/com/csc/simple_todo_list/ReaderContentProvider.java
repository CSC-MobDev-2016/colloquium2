...
public class ReaderContentProvider extends ContentProvider {
    public static final String AUTHORITY = "com.csc.simple_todo_list";
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY);
    public static final String SORT_ORDER = ToDoTable.COLUMN_DONE  + " ASC, " +
            ToDoTable.COLUMN_STARRED + " DESC, " + ToDoTable.COLUMN_DATE + " DESC";
    ...
    public ReaderContentProvider() {
        helper = new ToDoOpenHelper(getContext());
    }
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection,
        ...
        return helper.getWritableDatabase().update(ToDoTable.TABLE_NAME, values, selection, selectionArgs);
    }
}
